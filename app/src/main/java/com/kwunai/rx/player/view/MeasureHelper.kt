...
class MeasureHelper {
    ...
    fun doMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int): Boolean {
        ...
        // 输入宽高spec
        Logger.d("on measure, input widthMeasureSpec=" + View.MeasureSpec.toString(widthMeasureSpec)
        ...
        if (mVideoScaleMode === VideoScaleMode.FILL) {
            ...
            if (widthSpecMode == View.MeasureSpec.AT_MOST && heightSpecMode == View.MeasureSpec.AT_MOST) {
                ...
                if (mVideoScaleMode === VideoScaleMode.FIT) {
                    ...
                    Logger.d("on measure, unsupported scale mode!!!")
                }
                ...
                Logger.d("on measure, unsupported spec mode!!!")
            }
        } else {
            Logger.d("on measure, unsupported spec mode!!!")
        }
        ...
        Logger.d("on measure done, set measure width=$mMeasuredWidth, height=$mMeasuredHeight")
        return true
    }
